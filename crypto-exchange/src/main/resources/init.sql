...
INSERT INTO CRYPTO_USER (CREATED_AT, DELETED_AT, UPDATED_AT, CRYPTO_WALLET_ADDRESS, CVU, EMAIL, LAST_NAME, NAME, PASSWORD, REPUTATION) VALUES (CURRENT_TIMESTAMP,NULL,CURRENT_TIMESTAMP,'12345679','1111111111111111111111','fabi@test.com','Frangella','Fabian','{bcrypt}$2a$10$y5zuwUGdKKgAVQCXphtzKOMmH.8NiLCEJZPQ0XiezGvs7g6xYFlCi',0);
INSERT INTO CRYPTO_USER (CREATED_AT, DELETED_AT, UPDATED_AT, CRYPTO_WALLET_ADDRESS, CVU, EMAIL, LAST_NAME, NAME, PASSWORD, REPUTATION) VALUES (CURRENT_TIMESTAMP,NULL,CURRENT_TIMESTAMP,'12345679','1111111111111111111111','andy@test.com','Mora','Andres','{bcrypt}$2a$10$iZDqpk22QRevVh4KeH702..6PAfXHDOcW70sgkagbHficanLDvSuC',0);
